...
const translations = {
  id: {
    ...
    "virtual-tutor.api-key-not-set": "⚠️ API key belum disetel. Silakan setup API key terlebih dahulu.",
    ...
    "common.dark-mode-active": "🌙 Mode gelap aktif",
    "common.light-mode-active": "☀️ Mode terang aktif",
  ...
  en: {
    ...
    "virtual-tutor.api-key-not-set": "⚠️ API key not set. Please set up the API key first.",
    "virtual-tutor.api-key-invalid-format":
    ...
    "common.dark-mode-active": "🌙 Dark mode active",
    "common.light-mode-active": "☀️ Light mode active",
