          ...
          <Card>
            <CardContent className="p-4 md:p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs md:text-sm font-medium text-gray-600 dark:text-gray-400">
                    {t("analytics.completed-materials")}
                  </p>
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription className="text-sm">
                  {t("analytics.individual-student-performance-description")}
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription className="text-sm">
                    {t("analytics.ai-insights-predictions-description")}
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-lg">
                    <h4 className="font-semibold text-blue-800 dark:text-blue-300 mb-2">
                      📈 {t("common.positive-trend")}
                    </h4>
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription className="text-sm">
                    {t("analytics.learning-optimization-description")}
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {t("common.adjust-difficulty-based-on-performance")}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {t("common.schedule-difficult-material")}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {t("common.increase-simulation-gamification")}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-start space-x-3">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          {t("common.implement-auto-feedback")}
                        </p>
                      </div>
                    </div>
                  </div>
