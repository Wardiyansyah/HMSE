...
import { ArrowLeft, FileText, AlertTriangle, CheckCircle, XCircle, Scale, Phone, Mail, Facebook, Twitter, Instagram } from "lucide-react"
...
export default function SyaratKetentuanPage() {
  return (
    <main className="min-h-screen bg-gray-900 text-white">
      {/* Header */}
      {/* (Anda dapat menambahkan header di sini jika perlu) */}
      ...
      <main className="px-6 py-12">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-20 relative">
            ...
            <div className="relative">
              <div className="inline-flex items-center gap-2 bg-blue-600/10 backdrop-blur-sm border border-blue-500/20 rounded-full px-6 py-2 mb-6">
                ...
                <span className="text-blue-300 text-sm font-medium">Ketentuan Layanan</span>
              </div>
              ...
              <p className="text-xl text-gray-300 leading-relaxed max-w-3xl mx-auto mb-4">
                Ketentuan penggunaan platform pembelajaran InsanAI yang adil dan transparan
              </p>
            </div>
          </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-gray-800/80 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 hover:border-blue-500/30 transition-all duration-300">
                ...
                <p className="text-gray-300 leading-relaxed text-lg">
                  Dengan mengakses dan menggunakan platform InsanAI, Anda menyetujui untuk terikat dengan syarat dan
                  ketentuan ini. Jika Anda tidak menyetujui ketentuan ini, mohon untuk tidak menggunakan layanan kami.
                  Ketentuan ini dirancang untuk melindungi semua pengguna dan memastikan pengalaman pembelajaran yang
                  optimal.
                </p>
              </div>
            </div>
              ...
              <div className="relative bg-gray-800/80 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 hover:border-green-500/30 transition-all duration-300">
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div className="bg-gray-700/50 rounded-xl p-6 border border-gray-600/30">
                    <h3 className="text-xl font-semibold text-white mb-4">Pendaftaran Akun</h3>
                  ...
                  <div className="bg-gray-700/50 rounded-xl p-6 border border-gray-600/30">
                    <h3 className="text-xl font-semibold text-white mb-4">Penggunaan Akun</h3>
                    <ul className="text-gray-300 space-y-2 text-sm">
                      ...
                      <li>• Laporkan segera jika akun Anda disalahgunakan</li>
                      <li>• Gunakan informasi profil yang sesuai dan pantas</li>
                    </ul>
                  </div>
                </div>
              </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 mb-16">
            <div className="group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-600/20 to-cyan-600/20 rounded-2xl blur-xl"></div>
              <div className="relative bg-gray-800/80 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 hover:border-blue-500/30 transition-all duration-300 h-full">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-white">Penggunaan yang Diizinkan</h2>
                </div>
                <ul className="text-gray-300 space-y-3 text-sm">
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>Mengakses materi pembelajaran untuk tujuan edukasi</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>Berinteraksi dengan fitur AI untuk pembelajaran personal</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>Berbagi progres dengan guru atau orang tua (jika diizinkan)</span>
                  </li>
                   <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>Memberikan feedback untuk peningkatan platform</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-4 h-4 text-green-400 mt-0.5 flex-shrink-0" />
                    <span>Mengunduh materi untuk penggunaan offline personal</span>
                  </li>
                </ul>
              </div>
            </div>
            ...
            <div className="group relative">
              ...
              <div className="relative bg-gray-800/80 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 hover:border-red-500/30 transition-all duration-300 h-full">
                <div className="flex items-center gap-4 mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-white">Aktivitas yang Dilarang</h2>
                </div>
                <ul className="text-gray-300 space-y-3 text-sm">
                  <li className="flex items-start gap-2">
                    <XCircle className="w-4 h-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>Menyalahgunakan atau merusak sistem platform</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <XCircle className="w-4 h-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>Berbagi akun dengan orang lain</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <XCircle className="w-4 h-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>Mendistribusikan konten tanpa izin</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <XCircle className="w-4 h-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>Menggunakan bot atau script otomatis</span>
                  </li>
                  <li className="flex items-start gap-2">
                    <XCircle className="w-4 h-4 text-red-400 mt-0.5 flex-shrink-0" />
                    <span>Melakukan reverse engineering pada sistem AI</span>
                  </li>
                </ul>
              </div>
            </div>
              ...
              <div className="relative bg-gray-800/80 backdrop-blur-sm border border-gray-700/50 rounded-2xl p-8 hover:border-purple-500/30 transition-all duration-300">
                ...
                <div className="space-y-6">
                  <p className="text-gray-300 leading-relaxed">
                    InsanAI menyediakan platform "sebagaimana adanya" dan tidak memberikan jaminan bahwa:
                  </p>
                  <div className="grid md:grid-cols-2 gap-4">
                    {[
                      "Layanan akan selalu tersedia tanpa gangguan",
                      "Semua informasi akurat dan terkini",
                      "Platform bebas dari bug atau error",
                      "Hasil pembelajaran akan sesuai ekspektasi",
                    ].map((item, index) => (
                  ...
                  <p className="text-gray-300 leading-relaxed">
                    InsanAI tidak bertanggung jawab atas kerugian langsung atau tidak langsung yang timbul dari
            ...
            <div className="group relative">
              ...
              <div className="relative bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 rounded-3xl p-12 text-center">
                ...
                <p className="text-gray-300 leading-relaxed mb-8 max-w-3xl mx-auto text-lg">
                  InsanAI dapat mengubah syarat dan ketentuan ini sewaktu-waktu. Perubahan akan diberitahukan melalui
                  email atau notifikasi di platform. Penggunaan berkelanjutan setelah perubahan dianggap sebagai
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 bg-gradient-to-r from-blue-600/10 to-purple-600/10 rounded-2xl p-6 backdrop-blur-sm border border-blue-500/20">
                  <div className="text-center">
                    <p className="text-gray-300 mb-2">Untuk pertanyaan tentang syarat dan ketentuan:</p>
                    <div className="flex flex-col sm:flex-row items-center gap-4">
                      <div className="flex items-center gap-2 text-blue-300">
                        <Mail className="w-5 h-5" />
                        <span className="font-medium">legal@insanai.id</span>
                      </div>
