          ...
          <TabsContent value="youtube" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Video berkualitas tinggi dari channel edukasi terpercaya, dipilih berdasarkan kategori dan level
                </CardDescription>
              </CardHeader>
              <CardContent>
                {selectedCategory === "all" || selectedLevel === "all" ? (
                  <div className="text-center py-12">
                    ...
                    <h3 className="text-xl font-semibold text-gray-600 dark:text-gray-300 mb-2">
                      {t("library.select-category-level")}
                    </h3>
                    <p className="text-gray-500 dark:text-gray-400 mb-4">
                      {t("library.select-category-level-description")}
                    </p>
                  </div>
                ) : isLoadingVideos ? (
                  <div className="text-center py-12">
