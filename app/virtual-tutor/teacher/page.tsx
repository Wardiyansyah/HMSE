  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      ...
      content: `Halo ${
        user?.name || 'Guru'
      }! 👋 Saya AI Tutor InsanAI, siap membantu Anda mengajar lebih efektif dengan:\n• Pembuatan soal latihan otomatis\n• Rancangan materi interaktif & ringkasan pelajaran\n• Analisis kesulitan siswa berdasarkan data kelas\n• Saran metode pengajaran dan strategi pembelajaran`,
  ...
  const quickQuestions = [
    {
      ...
      text: 'Buat 10 soal pilihan ganda tentang hukum Newton',
      subject: 'Fisika',
    },
    {
      icon: <Beaker className="h-4 w-4" />,
      text: 'Ringkas materi fotosintesis dalam bentuk poin singkat',
      subject: 'Biologi',
    },
    {
      icon: <History className="h-4 w-4" />,
      text: 'Rancang RPP singkat untuk materi kemerdekaan Indonesia',
      subject: 'Sejarah',
    },
    {
      icon: <Calculator className="h-4 w-4" />,
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                <div className="flex items-center space-x-2 text-sm">
                  ...
                  <span>Generator Soal & Ujian</span>
                </div>
                <div className="flex items-center space-x-2 text-sm">
                  <Calculator className="h-4 w-4 text-green-600 flex-shrink-0" />
                  <span>Ringkasan Materi & Modul Interaktif</span>
                </div>
                <div className="flex items-center space-x-2 text-sm">
                  <FileText className="h-4 w-4 text-purple-600 flex-shrink-0" />
                  <span>Analisis Hasil Belajar Siswa</span>
                </div>
                <div className="flex items-center space-x-2 text-sm">
                  <Beaker className="h-4 w-4 text-orange-600 flex-shrink-0" />
                  <span>Rekomendasi Strategi Mengajar</span>
                </div>
              </CardContent>
            </Card>
          </div>
